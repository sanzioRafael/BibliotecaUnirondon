			...
			'2':begin
				...
				begin
					...
					begin
						read(arqU, livros);
						gotoxy(2, i);
						write(livros.identificador,' - Nome: ',livros.nome,' - Autor: ',livros.autor,' - Editora: ',livros.editora,' - Obra: ',livros.obra,' - ISBN: ',livros.isbn,' - Ano de Publica,#135,ao: ',livros.anoPubl);     
						i:= i + 1;
